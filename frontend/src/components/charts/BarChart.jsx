...
const BarChart = ({ data, labels, colors, horizontal = false }) => {
    ...
    <ResponsiveContainer width="100%" height="100%">
      <RechartsBar data={chartData} layout={horizontal ? 'vertical' : 'horizontal'}
        ...
        {horizontal ? (
          ...
          <><XAxis dataKey="name" angle={-45} textAnchor="end" height={70} interval={0} /><YAxis /></>
        )}
        <Tooltip contentStyle={{ backgroundColor: '#fff', borderRadius: 8, boxShadow: '0 4px 12px rgba(0,0,0,0.15)' }} />
        <Legend />
